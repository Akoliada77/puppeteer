...
var titleSelector = '.styles-module--headline--OvNIf'
var subtitleSelector = '.styles-module--description--MvEw6.subtitle'
var counterSelector = '.styles-module--countersDirection--vfBG8'
var buttonSelector = '.styles-module--btnContainer--OMxTg'
var headerSelector = '.styles-module--header--g--9a'
...
export default class FirstSection {
    ...
    async countersChanging() {
        ...
        expect(classValue._remoteObject.value).to.eq('styles-module--wrapper--rwACu styles-module--circleVisible--614np')
        ...
        expect(classValue._remoteObject.value).to.equal('styles-module--wrapper--rwACu styles-module--circleVisible--614np')
